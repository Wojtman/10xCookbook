...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    ...
    return jsonErrorResponse(400, "validation_error", "OpenRouter stream request failed validation.", requestId);
  }
  ...
  try {
    ...
    return jsonErrorResponse(500, "openrouter_configuration_error", "OpenRouter service is not available.", requestId);
  }
...
function mapStreamServiceError(details: ServiceError, requestId: string): ApiErrorBody {
